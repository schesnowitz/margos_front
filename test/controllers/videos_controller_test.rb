...
class VideosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create video" do
    assert_difference('Video.count') do
      post videos_url, params: { video: { internal_url: @video.internal_url, url: @video.url } }
    end
  ...
  test "should update video" do
    patch video_url(@video), params: { video: { internal_url: @video.internal_url, url: @video.url } }
